...
import { clearSession, getMe } from '@/lib/auth';
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-800">
        <div className="w-9 h-9 bg-primary-600 rounded-xl flex items-center justify-center flex-shrink-0">
          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 2a8 8 0 100 16A8 8 0 0010 2zm-1 12V6h2v8H9z" />
          </svg>
        </div>
        <div>
          <div className="text-sm font-bold text-white leading-tight">Casino Admin</div>
      ...
      <div className="border-t border-gray-800 p-4 space-y-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-sm font-medium text-gray-200 truncate">{me?.username ?? '...'}</div>
